...
const ViewTasks = () => {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 'High':
        return 'rgba(255, 0, 0, 0.72)';
      case 'Medium':
        return 'rgba(251, 190, 0, 0.5)';
      case 'Low':
        return 'rgba(0, 158, 0, 0.3)';
      default:
        return 'transparent';
    }
  };
  ...
  return (
    <Container maxWidth="md" sx={{ marginTop: 4 }}>
      <Typography variant="h2" component="h2" gutterBottom sx={{ textAlign: 'center', marginBottom: 2,textDecoration: 'underline' }}>
        Tasks
      ...
      {tasks.length === 0 ? (
        ...
        >
          ...
          <Typography variant="body1" gutterBottom>
            You've completed all your tasks. Take a break and celebrate!
          </Typography>
        </Paper>
        ) : (
